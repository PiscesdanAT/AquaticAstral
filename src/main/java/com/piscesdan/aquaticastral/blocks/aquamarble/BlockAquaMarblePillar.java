...
public class BlockAquaMarblePillar extends BlockMarbleTemplate implements IWaterLoggable
{
    ...
    protected VoxelShape createPillarTopShape()
    {
        ...
        return VoxelUtils.combineAll(IBooleanFunction.OR, column, top);
    }
    ...
    protected VoxelShape createPillarBottomShape()
    {
        ...
        return VoxelUtils.combineAll(IBooleanFunction.OR, column, bottom);
    }
    ...
    {
        boolean hasUp = world.getBlockState(pos.up()).getBlock() instanceof BlockAquaMarblePillar;
        boolean hasDown = world.getBlockState(pos.down()).getBlock() instanceof BlockAquaMarblePillar;
        if(hasUp)
        {
            if(hasDown)
            {
